    ...
    if (
      ...
      if (hand.length > 0) {
        ...
        const GE = new fp.GestureEstimator([
          ...
          Handsigns.NormaleSign,
          Handsigns.TuttoSign,
          Handsigns.VolereSign,
          Handsigns.DonnaSign,
          Handsigns.EsempioSign,
          Handsigns.EsperienzaSign,
          Handsigns.FeliceSign,
          Handsigns.ImportanteSign,
          Handsigns.SentireSign,
          Handsigns.UomoSign,
        ])
        // using a minimum match score of 8.5 (out of 10)
        const estimatedGestures = await GE.estimate(hand[0].landmarks, 9)
